...
elif menu == "📊 Phương Pháp Phân Cụm":
...
elif menu == "🧪 Trải Nghiệm sản phẩm":
            ...
            if st.button("🤖 Phân cụm bằng KMeans"):
                try:
                    ...
                    if cluster_label == 0:
                        ...
                        st.success(f"KMeans: Khách hàng là **LOYAL CUSTOMERS** {rfm_info}")
                    elif cluster_label == 3:
                        st.success(f"KMeans: Khách hàng là **AT-RISK CUSTOMERS** {rfm_info}")
